<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoArticulos.aspx.cs" Inherits="InventarioProyectoJDMoya.TipoArticulos" %>
...
<link href="CSS/Estilo.css" rel="stylesheet" />
    <title>TipoArticulos</title>
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <h2>Catalogo de tipos de Articulo</h2>
        </div>
        <div>
	<ul>
